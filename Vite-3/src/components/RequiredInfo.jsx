...
import Clippath from "../assets/svg/Clip path group.svg";
    ...
    <div className={`required-info-section ${className}`}>
      <div className="info-card">
        ...
        <div className="comment-section">
          <label className="section-subheading" htmlFor="comment-textarea">Comment (Max 500 Chars)</label>
        ...
        <div className="actions-row">
          <button type="button" className="btn restart-button" onClick={handleRestart}>Restart</button>
          <button type="button" className="btn approve-button" onClick={handleSubmit}>Approve</button>
        </div>
        {/* Transfer Workflow Sub-heading at bottom */}
        <div className="transfer-workflow">
          <div className="transfer-workflow-left">
            <img
              src={Clippath}
              alt="Clippath-icon"
              className="clippath-icon"
              width="20"
              height="20"
            />
